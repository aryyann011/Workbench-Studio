  ...
  return (
    <div className="relative min-h-screen w-full bg-background flex flex-col items-center justify-center overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-[420px] p-4">
        <div className="bg-card/90 border border-border rounded-2xl p-8 shadow-2xl backdrop-blur-2xl flex flex-col gap-6 relative">
          ...
          <div className="flex flex-col items-center text-center gap-2">
            <div className="w-10 h-10 rounded-full bg-foreground text-background flex items-center justify-center font-black text-lg mb-2 shadow-inner">
              W
            </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-muted border border-border hover:border-border text-foreground rounded-xl py-3 px-4 font-medium transition-all active:scale-[0.98] cursor-pointer shadow-sm"
          >
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-muted/40 border border-border hover:border-border focus:border-blue-500/80 focus:ring-1 focus:ring-blue-500/20 text-foreground rounded-xl py-2.5 pl-9 pr-4 text-sm transition-all outline-none font-sans"
                  required
                  disabled={isLoading}
                />
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-foreground text-background hover:bg-foreground/90 transition-all font-semibold rounded-xl py-3 text-sm flex items-center justify-center gap-2 cursor-pointer shadow-md disabled:bg-muted disabled:text-muted-foreground active:scale-[0.99] mt-2"
            >
              {isLoading ? (
          ...
          <div className="text-center pt-2">
            <p className="text-muted-foreground text-xs">
              ...
              <Link href="/sign-up" className="text-foreground hover:text-foreground/80 font-semibold transition-colors">
                Sign up
              </Link>
            </p>
          </div>
