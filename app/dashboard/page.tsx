  ...
  return (
    <div className="p-6 w-full max-w-6xl mx-auto h-full overflow-y-auto">
      ...
      {sharedWithMe.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-8 border border-dashed border-border rounded-xl bg-card/50 text-center mb-12">
          <div className="p-3 bg-indigo-500/10 rounded-full mb-3">
            <Users className="w-6 h-6 text-indigo-400" />
          </div>
          <h3 className="text-sm font-semibold text-foreground mb-1">Nothing shared yet</h3>
          <p className="text-xs text-muted-foreground max-w-sm">When someone invites you to collaborate on their architecture, it will appear here.</p>
        </div>
      ) : (
